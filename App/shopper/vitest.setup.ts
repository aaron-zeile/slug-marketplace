...
const intlMessages: Record<string, Record<string, string>> = {
  ...
  Home: {
    ...
    buyAgainItems: 'Buy again',
    buyAgainSubtitle: 'Revisit items from your recent orders.',
  ...
  Wishlist: {
    ...
    title: 'Wishlist',
    itemsInWishlist_one: '{count} item in your wishlist',
    itemsInWishlist_other: '{count} items in your wishlist',
    loading: 'Loading your wishlist...',
    loadError: 'Unable to load your wishlist.',
    empty: 'Your wishlist is empty.',
    signInToView: 'Sign in to view your wishlist.',
    itemAriaLabel: 'Wishlist item {name}',
  ...
  Orders: {
    title: 'Orders',
    subtitle: 'View your current order history.',
    ...
    viewBreakdown: 'View item breakdown',
    hideBreakdown: 'Hide item breakdown',
    orderTotal: 'Order total',
    noImage: 'No image',
    itemUnavailable: 'This listing is no longer available.',

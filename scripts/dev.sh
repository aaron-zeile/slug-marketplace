...
docker rm -f app postgres marketplace_shopper_service marketplace_items_service marketplace_login_service marketplace_items_db items-service-db cart-service-db 2>/dev/null || true

for port in 3000 3002 3010 4000 4010 4500 4600 5173; do
